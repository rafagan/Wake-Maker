...
- (IBAction)setBtAc:(id)sender
{
    ...
    else
    {
        ...
        [[APP_MNG.dataAccess returnAlarms]
            insertObject:[Alarm createAlarmWithMinutes:(int)minutes Hour:(int)hour Message:[[self textField] text] Days:_specificDays Music:selectedMusic AlarmMusicSystem:isMusic] atIndex:_row];
    }
